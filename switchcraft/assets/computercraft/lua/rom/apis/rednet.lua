...
function run()
    ...
    while bRunning do
        ...
        if sEvent == "modem_message" then
            ...
            if (nChannel == os.getComputerID() or nChannel == CHANNEL_BROADCAST) then
                if type(tMessage) == "table" and tMessage.nMessageID and (tMessage.nMessageID == tMessage.nMessageID) then
                    if not tReceivedMessages[tMessage.nMessageID] and isOpen(sModem) then
